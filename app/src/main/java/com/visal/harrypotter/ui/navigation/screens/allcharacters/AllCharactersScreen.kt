package com.visal.harrypotter.ui.navigation.screens.allcharacters
...
private const val TAG = "AllCharactersScreen"
...
//        AppBarTextComponent(stringResource(id = R.string.all_characters))
            TopAppBarWithBack(
                title = stringResource(id = R.string.all_characters),
                onBackClick = {
...
//        TopSearchBar2(searchQuery, viewModel::onSearchQueryChanged)
            TopSearchBar(
                searchQuery,
                onSearchQueryChanged = viewModel::onSearchQueryChanged,
                onSearchTriggered = {})
            CharactersListComponent(hpCharacters, searchQuery, navController)
        }
    }
...
//    AllCharactersScreen(navController = rememberNavController())
}