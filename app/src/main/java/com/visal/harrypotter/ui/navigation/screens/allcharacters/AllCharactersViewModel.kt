...
@HiltViewModel
class AllCharactersViewModel @Inject constructor(private val repository: AllCharactersRepository) :
    ViewModel() {

    companion object {
        const val TAG = "AllCharactersViewModel"
    }
    ...
    /**
     * Function for fetch All Harry Potter Characters data from server
     */
